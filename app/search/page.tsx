                        ...
                        <div className="flex items-center">
                          ...
                          <span className="text-gray-400">
                            {result.data.timestamp
                              ? new Date(result.data.timestamp).toLocaleString(undefined, {
                                  timeZoneName: 'short',
                                })
                              : 'N/A'}
                          </span>
                    ...
                    <div>
                      ...
                      <h3 className="text-lg font-bold text-gray-100 mb-2">
                        <Link
                          ...
                          title={String(result.data.hash)}
                        >
                          {String(result.data.hash).slice(0, 16)}...
                          {String(result.data.hash).slice(-16)}
                        </Link>
                      </h3>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                        <div>
                        ...
                        <div className="flex items-center">
                          ...
                          <span className="text-gray-400">
                            ...
                            <span className="text-green-400">
                              {result.data.value || '0'} {getCurrencySymbol()}
                            </span>
                          </span>
                        </div>
                      </div>
                    ...
                    <div>
                      ...
                      <div className="text-sm">
                        ...
                        <span className="text-green-400 ml-2">
                          {result.data.balance || '0'} {getCurrencySymbol()}
                        </span>
                      </div>
                    </div>
                  )}
