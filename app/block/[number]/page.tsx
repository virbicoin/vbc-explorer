                  ...
                  {block.miner !== '0x0000000000000000000000000000000000000000' && (
                    <div className="flex items-center gap-2">
                      <button
                        onClick={() => {
                          const minerInfo = getMinerDisplayInfo(block.miner);
                          const addressToCopy = minerInfo.isPool
                            ? minerInfo.address || block.miner
                            : block.miner;
                      ...
                      {copiedItem ===
                        (getMinerDisplayInfo(block.miner).isPool
                          ? getMinerDisplayInfo(block.miner).address || block.miner
                          : block.miner) && (
                        <span className="text-green-400 text-sm font-mono">Copied!</span>
                      )}
                    </div>
        ...
        <div className="bg-gray-800 rounded-lg border border-gray-700 p-6 mb-8">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex flex-col items-center">
              <div className="text-2xl font-bold text-white">Block #{block.number}</div>
