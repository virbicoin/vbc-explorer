    ...
    const fetchMiningRewards = async () => {
      try {
        ...
        const response = await fetch(
          `/api/address/${resolvedParams.address}/mining?page=${currentPage}&limit=${itemsPerPage}`
        );
        if (!response.ok) {
    ...
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <div className="bg-gray-800 border-b border-gray-700">
        <div className="container mx-auto px-4 py-8">
          ...
          <p className="text-gray-400">All mining rewards for address {resolvedParams.address}</p>
        </div>
      </div>
        ...
        <div className="bg-gray-800 rounded-lg border border-gray-700 p-6">
          ...
          {transactions.length === 0 ? (
            <p className="text-gray-400 text-center py-8">
              No mining rewards found for this address.
            </p>
          ) : (
            <>
              ...
              <div className="text-center mt-4 text-gray-400 text-sm">
                ...
                {totalTransactions.toLocaleString()} total mining rewards
              </div>
            </>
          )}
        </div>
