            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">
                    Choose the token you want to swap from (&quot;From&quot;) and the token you want
                    to receive (&quot;To&quot;), then enter the amount.
                  </p>
                </div>
              </div>
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">
                    Click &quot;Swap&quot; and confirm the transaction in your wallet. That&apos;s
                    it!
                  </p>
                </div>
              </div>
        ...
        <div className="max-w-lg mx-auto">
          <div className="bg-gradient-to-b from-gray-800/90 to-gray-900/90 backdrop-blur-xl rounded-3xl p-6 border border-gray-700/50">
            ...
            <p className="text-gray-300 mb-4 leading-relaxed">
              A <span className="text-blue-400 font-semibold">Decentralized Exchange (DEX)</span>{' '}
              allows you to swap tokens directly from your wallet without any intermediaries. Your
              assets stay in your control at all times — no need to deposit funds to a centralized
              platform.
            </p>
          ...
          <div className="bg-blue-500/10 border border-blue-500/30 rounded-xl p-5">
            ...
            <ul className="text-blue-200/80 space-y-2 text-sm">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong>Check Price Impact</strong> before swapping large amounts to avoid
                  unfavorable rates.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-blue-400">•</span>
                <span>
                  <strong>Slippage Tolerance</strong> of 0.5-1% works for most trades. Increase it
              ...
              <li className="flex items-start gap-2">
                <span className="text-blue-400">•</span>
                <span>
                  <strong>Keep native tokens</strong> in your wallet for gas fees (transaction
                  costs).
                </span>
              </li>
            </ul>
    ...
    <>
          ...
          <div className="space-y-4">
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">
                  You&apos;ll need <strong className="text-purple-300">equal value</strong> of both
                  tokens (e.g., 100 Token A + 10,000 Token B at current price).
                </p>
              </div>
            </div>
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">
                  Deposit your tokens and receive{' '}
                  <strong className="text-purple-300">LP tokens</strong> representing your share of
                  the pool.
                </p>
              </div>
            </div>
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">
                  Earn <strong className="text-green-400">0.3%</strong> of all trading fees. Plus,
                  stake your LP tokens in Farm for bonus rewards!
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="max-w-lg mx-auto mt-6">
        <div className="bg-gradient-to-b from-gray-800/90 to-gray-900/90 backdrop-blur-xl rounded-3xl p-6 border border-gray-700/50">
          ...
          <p className="text-gray-300 mb-4 leading-relaxed">
            <span className="text-cyan-400 font-semibold">LP (Liquidity Provider) tokens</span> are
            your &quot;receipt&quot; for the assets you&apos;ve deposited in the pool. They
            represent your proportional share of the liquidity pool.
          </p>
      ...
      <div className="max-w-lg mx-auto mt-6">
        <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-xl p-5">
          ...
          <p className="text-yellow-200/80 text-sm mb-3">
            When token prices change significantly, you may end up with less value than if you had
            simply held your tokens. This is called <strong>&quot;Impermanent Loss&quot;</strong>.
          </p>
          <p className="text-yellow-200/60 text-xs">
            💡 Trading fees and Farm rewards often offset this loss, but please understand the risks
    ...
    <>
          ...
          <div className="space-y-4">
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">
                  Go to the <strong className="text-purple-300">Pool</strong> tab and add liquidity
            ...
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">
                  Deposit your LP tokens into the farming pool using the &quot;Deposit&quot; button.
                </p>
              </div>
            </div>
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">
                  Your <strong className="text-green-400">VBCG rewards</strong> accumulate every
                  block. Harvest them anytime!
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="max-w-lg mx-auto mt-6">
        <div className="bg-gradient-to-b from-gray-800/90 to-gray-900/90 backdrop-blur-xl rounded-3xl p-6 border border-gray-700/50">
          ...
          <p className="text-gray-300 mb-4 leading-relaxed">
            <span className="text-yellow-400 font-semibold">Yield Farming</span> is a way to earn
            extra rewards by staking your LP tokens. While your liquidity already earns trading
            fees, farming gives you <strong>additional VBCG token rewards</strong>.
          </p>
        ...
        <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-5">
          ...
          <ul className="text-green-200/80 space-y-2 text-sm">
            <li className="flex items-start gap-2">
              <span className="text-green-400">•</span>
              <span>
                <strong>No Lock-up:</strong> Withdraw your LP tokens anytime with no penalties.
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-green-400">•</span>
              <span>
                <strong>Compound or Harvest:</strong> Let rewards accumulate or harvest them
                regularly — it&apos;s up to you!
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-green-400">•</span>
              <span>
                <strong>Double Earnings:</strong> You earn both trading fees (from Pool) AND VBCG
                rewards (from Farm).
              </span>
            </li>
          </ul>
...
function ContractAddresses() {
  const contracts: {
    ...
    {
      name: 'SimpleFactoryV2',
      address: '0x663B1b42B79077AaC918515D3f57FED6820Dad63',
      description: 'Creates LP pairs',
      type: 'contract',
    },
    {
      name: 'SimpleRouterV2',
      address: '0xdD1Ae4345252FFEA67fE844296fbd6C973B98c18',
      description: 'Swap & liquidity routing',
      type: 'contract',
    },
    {
      name: 'WVBC',
      address: '0x52CB9F0d65D9d4De08CF103153C7A1A97567Bb9b',
      description: 'Wrapped VirBiCoin',
      type: 'token',
    },
    {
      name: 'MasterChefV2',
    ...
    {
      name: 'TokenFactory',
      address: '0x5721a3A9fc168a8Ac1c8A2Cfca9c61C8189d8618',
      description: 'Token creation',
      type: 'contract',
    },
    {
      name: 'VBCG',
      address: '0xac7F60af25C5c4E23d1008C46511e265A8c9B6cF',
      description: 'VirBiCoin Gold',
      type: 'token',
    },
    {
      name: 'USDT',
      address: '0xdf136683B118E95c04A61FEC091c65736d9de059',
      description: 'Tether USD (VBC)',
      type: 'token',
    },
  ];
