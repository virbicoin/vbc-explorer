      ...
      if (result.status === 'success' && result.result) {
        ...
        const deadBalance =
          deadBalanceResult?.status === 'success'
            ? (deadBalanceResult.result as bigint)
            : BigInt(0);
    ...
    <div className="max-w-4xl mx-auto">
      <div className="bg-gradient-to-b from-gray-800/90 to-gray-900/90 backdrop-blur-xl rounded-3xl p-6 shadow-xl border border-gray-700/50">
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="text-gray-400 text-sm">{tokens.length} tokens created</div>
        </div>
    ...
    >
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div
            className={`w-12 h-12 bg-gradient-to-br from-purple-500 to-pink-500 rounded-full flex items-center justify-center text-white font-bold text-lg ${token.logoUrl ? 'hidden' : ''}`}
          >
          ...
          <div>
            ...
            {token.description && (
              <p className="text-gray-500 text-xs mt-0.5 line-clamp-1 max-w-md">
                {token.description}
              </p>
            )}
